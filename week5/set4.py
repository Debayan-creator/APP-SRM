...
line2 = Label(window, text="Total amount payable ZAR__ x_ nights = ZAR__ due to Arabella Hotel and Spa")
...
line5 = Label(window, text="Terms and conditions can be found on the next page.")
...
btn = Button(window ,text="SUBMIT",width=20,bg="white").grid(row=30,column=2)
btn = Button(window,text="DISPLAY RECORD(s)",width=20,bg="white").grid(row=30,column=3)
window.mainloop()
