...
Label(root, text="Flight: ").grid(row=2, column=0)
Entry(root).grid(row=2, column=1)
a = IntVar()
Label(root, text="Source").grid(row=3, column=0)
Radiobutton(root, value=0, variable=a, text='Delhi').grid(row=3, column=1)
Radiobutton(root, value=1, variable=a, text='Mumbai').grid(row=3, column=2)
Label(root, text="Destination").grid(row=3, column=3)
Radiobutton(root, value=1, variable=a, text='Chennai').grid(row=3, column=4)
Radiobutton(root, value=1, variable=a, text='Kolkata').grid(row=3, column=5)
Label(root, text='Duration').grid(row=4, column=0)
